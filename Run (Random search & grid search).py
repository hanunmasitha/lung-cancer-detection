...
sys.path.append(os.path.abspath("E:\Koding\Python\fix TA"))
from TA.Arsitektur import LeNet, AlexNet, ResNet
import preprocessing
import hyperparameter
import performance_meansure
...
best_param = hyperparameter.RandomSearch(train_data,
                                       AlexNet.getModel)

cnn = AlexNet.getModel(best_param['activation_function'],
...
previous_model = load_model('Save Model/model.h5')
